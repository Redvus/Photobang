(function ($) {
    ...
    //     controller.open( 'nav-mobile' );
    //     $('.close--nav').removeClass('close--hidden');
    // });
    // $( '#nav_close' ).on( 'click', function () {
    //     controller.close( 'nav-mobile' );
    //     $('.close--nav').addClass('close--hidden');
    // });
    ...
    var navMenu = $("#nav_main"),
        navBack = $("#navBack"),
        navToggle = $("#nav_toggle"),
        navMenuBack = $("#menu_back"),
        headerTopLogo = $(".header-logo"),
        wrapper = $(".wrapper"),
        navMenuIcon = $("#menu_icon"),
        navMenuUp = $("#menu_up"),
        navMenuDown = $("#menu_down"),
        navMenuArrow = $("#menu_arrow"),
        navMenuCross = $("#menu_cross"),
        navMenuIconOver = $("#menu_icon_over"),
        navMenuUpOver = $("#menu_up_over"),
        navMenuDownOver = $("#menu_down_over"),
        navMenuArrowOver = $("#menu_arrow_over"),
        navClose = $('#navClose')
    ;
    ...
    function menuLeft() {
        ...
        tl
            ...
            .to(navMenuArrow, 0.6, {
                ...
                ease: Back.easeInOut},
                "-=1.3")
            // .set(navBack, {className: "+=nav-back--visible"})
            .to(navMenu, 0.8, {
                left: "0",
                zIndex: "9700",
            ...
            .to(headerTopLogo, 0.6, {
                x: "-120%",
                ease: Power2.easeInOut},
                "-=1.2")
            // .set(navToggle, {className: "nav-toggle--open"})
            // // .to(navMenuIconOver, 0.8, {autoAlpha: 1, ease: Power3.easeInOut}, "-=0.8")
            // .to(navMenuUpOver, 0.6, {
            //     x: "200%",
            //     ease: Back.easeInOut},
            //     "-=1.2")
            // .to(navMenuDownOver, 0.6, {
            //     x: "200%",
            //     ease: Back.easeInOut},
            //     "-=1.2")
            // .to(navMenuArrowOver, 0.6, {
            //     x: "200%",
            //     autoAlpha: 1,
            //     ease: Back.easeInOut},
            //     "-=1.2")
    ...
    // if($(window).width() > 768) {
    //    $('.options-content__bottom').niceScroll({
    //         cursorcolor: "#gray",
    //         scrollspeed: 120,
    //         //mousescrollstep: 80
    //     });
    ...
    // var vendorsHeader = $('.vendor-grid__sort > h2'),
    //     vendorSection = $('.vendor-grid__sort')
    // ;
    ...
    //     triggerElement: vendorSection,
    //     triggerHook: 0
    //     // duration: '100%'
    // })
    // .setPin(vendorsHeader)
    // .addIndicators({
    //     name: 'infoSection'
    // })
    // .addTo(controller)
    ...
    // vendorsHeader.each( function() {
    //     var vendorSection = new ScrollMagic.Scene({
    //         triggerElement: vendorSection,
    //         triggerHook: 0
    //     })
    //     .setPin( this )
    ...
    /*=====  End of Scrollmagic Vendors  ======*/


    /*==================================================
    =            Замена фильтра «Сочетания»            =
    ==================================================*/

    // $(".category-filter__filters span").each(function() {
    //     var text = $(this).html();
    //     text = text.replace("Мюскадель", "<svg xmlns=\"http://www.w3.org/2000/svg\" viewBox=\"0 0 20 20\" id=\"miniCartClose\"><polygon points=\"20 8.5 11.5 8.5 11.5 0 8.5 0 8.5 8.5 0 8.5 0 11.5 8.5 11.5 8.5 20 11.5 20 11.5 11.5 20 11.5 20 8.5\"/></svg>");
    //     $(this).html(text);
    // });

    /*=====  End of Замена фильтра «Сочетания»  ======*/
